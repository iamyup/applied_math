...
Decision tree classifier generates the actual prediction at the leaf nodes, more information is needed to be stored at the leaf nodes than class likelihoods.
generally NB << DT.
'''
